...
- [x] Нижні вкладки (Головний · Тренування · Налаштування) з плаваючим баром;
  централізована палітра кольорів (`src/theme`) — готова до перемикання тем
...
```
src/
  app/(tabs)/   # вкладки: Головний, Тренування, Налаштування (+ layout)
  ...
  components/   # спільні компоненти (плаваючий таб-бар тощо)
